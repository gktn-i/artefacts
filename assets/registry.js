          ...
          modules: [
            {
              ...
              sections: [
                ...
                { h: "messen", t: "Messen & Werte" },
                { h: "fehlersuche", t: "Fehlersuche" },
            ...
            },
            {
              ...
              sections: [
                { h: "start", t: "Start & Workflow" },
                { h: "equipment", t: "Equipment" },
                { h: "mikroskop", t: "Mikroskop" },
                { h: "material", t: "Lot & Flussmittel" },
                { h: "draht", t: "Draht & Litze" },
                { h: "finish", t: "Reinigen & Schützen" },
                { h: "tht", t: "THT löten" },
                { h: "smd", t: "SMD löten" },
